...
<form action="{{ route('alunos.store') }}" method="POST">
        ...
        <div class="col" >
            <div class="form-floating mb-3">
                <input
                    ...
                    name="matricula"
                    placeholder="Numero de Matricula do Aluno"
                    value="{{old('matricula')}}"
                />
                <label for="matricula">Numero de Matricula do Aluno</label>
    ...
    <div class="row">
        <div class="col">
            ...
            <label class="input-group-text bg-success text-white" for="inputGroupSelect01" >Curso</label>
