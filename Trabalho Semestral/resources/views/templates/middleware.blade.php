    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary">
            <div class="container-fluid">
                <a href="dashboard" class="navbar-brand ms-sm-3">
                      {{-- <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
                        ...
                        <span class="ms-3 fs-5">Biblioteca</span>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{route('generos.index')}}" class="dropdown-item">Generos</a></li>
                                @endif
                                @if(UserPermissions::isAuthorized('livros.index'))
                                    <li><a href="{{route('livros.index')}}" class="dropdown-item">Livros</a></li>
                                @endif
                            </ul>
                        </li>
