...
<html lang="pt-br">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{route('eixos.index')}}" class="dropdown-item">Áreas/Eixos</a></li>
        ...
        <div class="container py-4">
            <div class="row">
                ...
                @if(isset($rota) && $rota != 'docencia.create') 
        ...
        <nav class="navbar fixed-bottom navbar-dark bg-success">
            <div class="container-fluid">
                <span class="text-white fw-light">&copy; Sthefany Kimberly</span>
            </div>
        </nav>
    </body>
    ...
    <div class="modal fade" tabindex="-1" id="deactivateModal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title text-danger">Desativar</h5>
              <button type="button" class="btn-close" data-bs-dismiss="deactivateModal" onclick="closeDeactivateModal()" aria-label="Close"></button>
            </div>
            <input type="hidden" id="id_deactivate">
            <div class="modal-body text-secondary">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-block align-content-center" onclick="closeDeactivateModal()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
                        <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"/>
                    </svg>
                    &nbsp; Não
                </button>
              <button type="button" class="btn btn-danger" onclick="deactivate()">
                    Sim &nbsp;
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                    </svg>
    ...
    <div class="modal fade" tabindex="-1" id="vinculoModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger">Não é possivel desativar!</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="vinculoModal" onclick="closeVinculoModal()" aria-label="Close"></button>
                </div>
                <div class="modal-body text-secondary">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-block align-content-center" onclick="closeVinculoModal()">
                        OK
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" tabindex="-1" id="activateModal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title text-success">Ativar</h5>
              <button type="button" class="btn-close" data-bs-dismiss="activateModal" onclick="closeActivateModal()" aria-label="Close"></button>
            </div>
            <input type="hidden" id="id_activate">
            <div class="modal-body text-secondary">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-block align-content-center" onclick="closeActivateModal()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
                        <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"/>
                    </svg>
                    &nbsp; Não
    ...
    <div class="modal fade" tabindex="-1" id="saveModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title text-success">Salvar alterações</h5>
                <button type="button" class="btn-close" data-bs-dismiss="activateModal" onclick="closeSaveModal()" aria-label="Close"></button>
                </div>
                <input type="hidden" id="id_activate">
                <div class="modal-body text-secondary">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-block align-content-center" onclick="closeSaveModal()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
                            <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"/>
                        </svg>
                        &nbsp; Não
    ...
    <script type="text/javascript">
        ...
        function showDeactivateModal(id, nome, vinculos) {
            $('#id_deactivate').val(id);
            

            //$('#deactivateModal').modal().find('.modal-body').append("Deseja desativar o(a) professor(a) <b class='text-danger'>'"+nome+"'</b> ?");
            if (vinculos > 0) {
                $('#vinculoModal').modal().find('.modal-body').html("");
                $('#vinculoModal').modal().find('.modal-body').append("O(a) professor(a) <b class='text-danger'>'"+nome+"'</b> está vinculado(a) a <b class='text-danger'>"+vinculos+"</b> disciplinas.");
                $("#vinculoModal").modal('show');
            }else{
                $('#deactivateModal').modal().find('.modal-body').html("");
                $('#deactivateModal').modal().find('.modal-body').append("Deseja desativar o(a) professor(a) <b class='text-danger'>'"+nome+"'</b> ?");
        ...
        function deactivate() {
            let id = $('#id_deactivate').val();
            let form = "form_" + $('#id_deactivate').val();
            document.getElementById(form).submit();
            $("#deactivateModal").modal('hide')
        }
        ...
        function showActivateModal(id, nome) {
            $('#id_activate').val(id);
            $('#activateModal').modal().find('.modal-body').html("");
            $('#activateModal').modal().find('.modal-body').append("Deseja ativar o(a) professor(a) <b class='text-success'>'"+nome+"'</b> ?");
        ...
        function activate() {
            let id = $('#id_activate').val();
            let form = "form_" + $('#id_activate').val();
            document.getElementById(form).submit();
            $("#activateModal").modal('hide')
        }

        function showSaveModal() {
            $('#saveModal').modal().find('.modal-body').html("");
            $('#saveModal').modal().find('.modal-body').append("Deseja salvar alterações de vinculos entre disciplinas e profesores?");
